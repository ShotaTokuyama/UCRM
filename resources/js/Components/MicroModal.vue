...
<template>
  ...
  <button
    class="flex mx-auto text-white bg-teal-500 border-0 py-2 px-8 focus:outline-none hover:bg-teal-600 rounded text-lg mt-4"
    type="button" @click="searchCustomers">検索する</button>
</template>